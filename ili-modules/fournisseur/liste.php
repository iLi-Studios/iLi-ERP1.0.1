...
function get_fournisseur_list(){
	...
	while ($o=mysqli_fetch_object($r)){
		...
		<tr class="odd gradeX">
			...
			<td><a href="fournisseur?id='.$o->id_frn.'">'.$o->mf_frn.'</a></td>
			<td class="hidden-phone"><a href="fournisseur?id='.$o->id_frn.'">'.$o->nom_frn.'</a></td>
			<td class="hidden-phone"><a href="mailto:'.$o->email_frn.'">'.$o->email_frn.'</a></td>
			<td class="hidden-phone">'.$o->tel_frn.'</td>
			<td class="hidden-phone">'.$o->tel2_frn.'</td>
...
function users_pannel($id){
	...
	if($_SESSION['user_id_rank']==2){
		$up=user_privileges("FOURNISSEURS", $_SESSION['user_id']);$c=$up->c;
		//C
...
<div id="container" class="row-fluid"> 
	...
	<div id="main-content"> 
		...
		<div class="container-fluid"> 
			...
			<div class="row-fluid">
				<div class="span12">
					<h3 class="page-title"> Fournisseurs <small> Liste</small> </h3>
					<ul class="breadcrumb">
						<li> <a href="<?php echo $site; ?>"><i class="icon-home"></i></a><span class="divider">&nbsp;</span> </li>
						<li><a href="liste">Fournisseurs</a><span class="divider-last">&nbsp;</span></li>
					</ul>
				</div>
			</div>
			<!-- END PAGE HEADER--> 
				...
				<div class="span12">
                    ...
                    <div class="widget">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i>Liste des fournisseurs</h4>
                            ...
                            <table class="table table-striped table-bordered" id="sample_1">
								<thead>
									<tr>
										...
										<th width="15%">Code</th>
										<th class="hidden-phone" width="30%">Fournisseur</th>
										<th class="hidden-phone" width="24%">Email</th>
										<th class="hidden-phone" width="10%">Tel.1</th>
										<th class="hidden-phone" width="10%">Tel.2</th>
										<th class="hidden-phone" width="10%">Création</th>
									</tr>
								</thead>
								<tbody><?php get_fournisseur_list(); ?></tbody>
                        	</table>
                        </div>
                    </div>
