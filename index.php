							...
							<div class="widget">
								...
								<div class="widget-body">
									<div id="site_statistics_loading">
										<img src="ili-style-src/img/loading.gif" alt="loading" />
									</div>
								...
								<div class="widget-body">
                                    <div class="timeline-messages">
                                            ...
                                            <div class="msg-time-chat">
                                                <a class="message-img" href="#"><img alt="" src="ili-style-src/img/avatar1.jpg" class="avatar"></a>
                                            ...
                                            <!-- Comment -->
                                            <div class="msg-time-chat">
                                                <a class="message-img" href="#"><img alt="" src="ili-style-src/img/avatar2.jpg" class="avatar"></a>
